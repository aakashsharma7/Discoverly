...
export default function Home() {
  ...
  const fetchFavorites = async () => {
    try {
      ...
      // Extract place_data from each favorite record
        ...
        <section className="relative min-h-[85vh] overflow-hidden bg-black">
          ...
          <div className="relative container mx-auto px-4 h-full flex flex-col items-center justify-center text-white">
            ...
            >
              <motion.h1 
                variants={fadeInUp}
                className="text-5xl md:text-7xl font-bold mt-20 mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-200"
              >
                ...
                <div className="relative group">
                  ...
                  <div className="relative flex items-center bg-black/30 backdrop-blur-md rounded-full overflow-hidden">
                    ...
                    <button
                      type="submit"
                      disabled={isSearchLoading}
                      className="m-2 px-7 py-3 bg-primary-500 text-white font-medium rounded-full hover:bg-primary-600 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
              ...
              <div className="relative">
                ...
                <div className="relative p-8">
                  <div className="flex items-center justify-between mb-8">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="px-3 py-1 text-sm text-white bg-primary-500/20 rounded-full border border-primary-500/30">
                        AI-Powered
                      </span>
                    </div>
                  </div>
                  {searchError ? (
                    <div className="text-center py-12">
                      <div className="text-white text-lg">{searchError}</div>
                    </div>
                  ) : (
                    <SearchResults
                      places={results}
